"""Update monitored_databases table schema

Revision ID: a4729d6e1dbe
Revises: ee216b01ef22
Create Date: 2025-05-04 12:13:09.402879
...
def upgrade() -> None:
    ...
    op.add_column('monitored_databases', sa.Column('alias', sa.String(), nullable=False))
    op.add_column('monitored_databases', sa.Column('hostname', sa.String(), nullable=False))
    op.add_column('monitored_databases', sa.Column('db_name', sa.String(), nullable=False))
    op.add_column('monitored_databases', sa.Column('password', sa.String(), nullable=False))
    op.drop_index('ix_monitored_databases_name', table_name='monitored_databases')
    op.create_index(op.f('ix_monitored_databases_alias'), 'monitored_databases', ['alias'], unique=True)
    op.drop_column('monitored_databases', 'created_at')
    op.drop_column('monitored_databases', 'dbname')
    op.drop_column('monitored_databases', 'name')
    op.drop_column('monitored_databases', 'updated_at')
    op.drop_column('monitored_databases', 'host')
    op.drop_column('monitored_databases', 'is_active')
    op.drop_column('monitored_databases', 'password_encrypted')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # Keep operations for monitored_databases
    op.add_column('monitored_databases', sa.Column('password_encrypted', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('monitored_databases', sa.Column('is_active', sa.BOOLEAN(), autoincrement=False, nullable=False))
    op.add_column('monitored_databases', sa.Column('host', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('monitored_databases', sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('monitored_databases', sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('monitored_databases', sa.Column('dbname', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('monitored_databases', sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.drop_index(op.f('ix_monitored_databases_alias'), table_name='monitored_databases')
    op.create_index('ix_monitored_databases_name', 'monitored_databases', ['name'], unique=False)
    op.drop_column('monitored_databases', 'password')
    op.drop_column('monitored_databases', 'db_name')
    op.drop_column('monitored_databases', 'hostname')
    op.drop_column('monitored_databases', 'alias')
    ...
    # sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('snapshots_id_seq'::regclass)"), autoincrement=True, nullable=False),
